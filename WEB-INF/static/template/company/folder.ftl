...
<section class="met_section">
    <section class="met_section_head">
        <div class="left ny_loc font_14">当前位置<a href="../" title="">>首页</a> &gt; <a
    ...
    <#if folder_father.ename=="news" >
        <div class="met_module2_list">
            ...
            <div class="met_pager">
                <@shishuo_article_list_tag folderId=folder.folderId rows=10 page="${page}">
                    <#if page gt 1>
                        <a href="<@shishuo_folder_url_tag folderId=folder.folderId page=1/>" class="PreA">¿¿</a>
    ...
    <#elseif folder_father.ename=="products">
        <div class="met_module3_list">
            <ul class="list_1" style="visibility: visible;">
                <@shishuo_article_list_tag folderId=folder.folderId rows=12 page="${page}">
                    <#list tag_article_list as item>
                        <li style="width: 33.3333%;">
                            <a href="<@shishuo_article_url_tag articleId="${item.articleId}"/>" title="${item.title}" target="_self" style="width: 215px;">
                                <img src="${BASE_PATH}/${item.pictureUrl}" width="215" height="323">
...
<div style="float:right;margin-top: -450px;">
    	<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=3226477837&amp;site=qq&amp;menu=yes">
	<img border="0" src="http://wpa.qq.com/pa?p=2:3226477837:53" alt="在线 交谈" title="在线 交谈"></a>
	</div>
<#include "footer.ftl">
